...
Body doubling is a productivity strategy where an individual works in the presence of another person to help with focus and task completion. It's particularly popular in ADHD communities, though formal research is limited.

## State of Research

**Important caveat:** Research on body doubling is lacking since it is a relatively new area of study, with most being limited to master's theses. Its efficacy is mainly promoted through personal anecdotes, especially on social media platforms.
...
- **Findings on practice variety:**
  - Locations: cafés, libraries, with YouTube videos
  - Tasks: studying, household chores, exercising
...
Research indicates body doubling effectiveness varies based on:

- **Personality types** - Different people respond differently
- **Individual preferences** - Some prefer silence, others prefer interaction
- **Task type** - May work better for certain kinds of work
- **Relationship with body double** - Familiarity may matter

## Limitations Noted in Research

1. **Not a standalone solution** - Should be used with other coping strategies
2. **Controlled studies don't support claims** - Perceived benefit vs. measured benefit
3. **Mechanism unclear** - We don't know exactly why it works (when it does)
4. **Individual variation** - Doesn't work for everyone

## Recommendations for Practice

Based on the research:

- Body doubling can be **one tool among many**, not a sole strategy
- The **perception of benefit** may itself be valuable (placebo-like effect)
- **Variety of implementations** work (in-person, virtual, even parasocial)
- **Individual experimentation** is needed to find what works

## Sources

- [Healthline: Body Doubling for ADHD](https://www.healthline.com/health/adhd/body-double-adhd)
- [ADDA: The ADHD Body Double](https://add.org/the-body-double/)
- [Medical News Today: Body Doubling ADHD](https://www.medicalnewstoday.com/articles/body-doubling-adhd)
- [Wikipedia: Body Doubling](https://en.wikipedia.org/wiki/Body_doubling)
- [Understood: Body Doubling for ADHD](https://www.understood.org/en/articles/body-doubling-for-adhd-what-it-is-and-how-it-works)
